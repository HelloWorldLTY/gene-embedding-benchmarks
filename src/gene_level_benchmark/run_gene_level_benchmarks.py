...
if __name__ == '__main__':
    ...
    # OMIM
    doid_prop_use, doid_slim_use, doid_to_slim, graph, filtered_doid_to_slim = helper.load_annotations(reference_genes, gmt_direct ='data/gmt/omim.20231030.direct.gmt', gmt_prop = 'data/gmt/omim.20231030.prop.gmt', slim = 'data/slim_sets/doid_agr_slim.txt', obo = 'data/obo/doid.obo')
    holdout_dict, cv_fold1_dict, cv_fold2_dict, cv_fold3_dict = helper.fold_split(doid_prop_use, doid_slim_use, doid_to_slim)

    file_names = ["bin/omim_cv_fold1_dict.pkl", "bin/omim_cv_fold2_dict.pkl", "bin/omim_cv_fold3_dict.pkl", "bin/omim_holdout_dict.pkl"]
    ...
    # GO All
    go_prop_use, go_slim_use, go_to_slim, graph, filtered_go_to_slim = helper.load_annotations(reference_genes, gmt_direct ='data/gmt/hsa_EXP_ALL_BP_direct.gmt', gmt_prop = 'data/gmt/hsa_EXP_ALL_BP_prop.gmt', slim = 'data/slim_sets/goslim_agr.tsv', obo = 'data/obo/go.obo')
    holdout_dict, cv_fold1_dict, cv_fold2_dict, cv_fold3_dict = helper.fold_split(doid_prop_use, doid_slim_use, doid_to_slim)

    file_names = ["bin/go_cv_fold1_dict.pkl", "bin/go_cv_fold2_dict.pkl", "bin/go_cv_fold3_dict.pkl", "bin/go_holdout_dict.pkl"]
    data_dicts = [cv_fold1_dict, cv_fold2_dict, cv_fold3_dict, holdout_dict]
    ...
    # GO After 2020
    go_prop_use, go_slim_use, go_to_slim, graph, filtered_go_to_slim = helper.load_annotations(reference_genes, gmt_direct ='data/gmt/2020_hsa_ALL_BP_direct.gmt"', gmt_prop = 'data/gmt/2020_hsa_ALL_BP_propagated.gmt"', slim = 'data/slim_sets/goslim_agr.tsv', obo = 'data/obo/go.obo')
    holdout_dict, cv_fold1_dict, cv_fold2_dict, cv_fold3_dict = helper.fold_split(doid_prop_use, doid_slim_use, doid_to_slim)

    file_names = ["bin/go2020_cv_fold1_dict.pkl", "bin/go2020_cv_fold2_dict.pkl", "bin/go2020_cv_fold3_dict.pkl", "bin/go2020_holdout_dict.pkl"]
    data_dicts = [cv_fold1_dict, cv_fold2_dict, cv_fold3_dict, holdout_dict]
