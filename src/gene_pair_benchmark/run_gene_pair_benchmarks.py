...
if __name__ == "__main__":
    ...
    file_names = ["bin/sl_fold_splits_pairs.pkl", "bin/sl_fold_nodes.pkl", "bin/sl_holdout_pairs.pkl", "bin/sl_holdout_labels.pkl", "bin/sl_holdout_nodes.pkl"]
    ...
    # save holdout and fold splits 
    file_names = ["bin/ng_fold_splits_pairs.pkl", "bin/ng_fold_nodes.pkl", "bin/ng_holdout_pairs.pkl", "bin/ng_holdout_labels.pkl", "bin/ng_holdout_nodes.pkl"]
    data_dicts = [fold_splits, splits, holdout_pairs,  holdout_labels, holdout_nodes]
    ...
    ng_holdout_results_df.to_csv("results/gene_pair/ng_holdout_results.csv", index=False)
    ...
    # save holdout and fold splits 
    file_names = ["bin/tf_fold_splits_pairs.pkl", "bin/tf_fold_nodes.pkl", "bin/tf_holdout_pairs.pkl", "bin/tf_holdout_labels.pkl", "bin/tf_holdout_nodes.pkl"]
    data_dicts = [fold_splits, splits, holdout_pairs,  holdout_labels, holdout_nodes]
    ...
    tf_holdout_results_df.to_csv("results/gene_pair/tf_holdout_results.csv", index=False)
