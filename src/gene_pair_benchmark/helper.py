...
def setup_data(positive_pairs, splits, holdout_nodes, cv_nodes, num_folds = 3):
    ...
    return fold_splits, holdout_pairs, holdout_labels, final_train_pairs, final_train_labels

def run_SVM(embeddings, reference_node2index, splits, fold_splits, holdout_pairs, holdout_labels, final_train_pairs, final_train_labels, num_folds = 3, log_file="genepair_output_log.txt"):
