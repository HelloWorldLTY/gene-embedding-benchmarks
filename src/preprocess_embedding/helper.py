...
def process_embedding_files(file_names, scopes = 'uniprot', base_path='data/embeddings/original'):
    ...
    for file in file_names:
        if file.endswith('.csv'):
            ...
            mg_results = mg.querymany(uniprot_ids, scopes=scopes, fields='entrezgene', species='human')
